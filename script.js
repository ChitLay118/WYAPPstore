document.addEventListener('DOMContentLoaded', () => {
    ...
    const dummyApps = [
        ...
        {id:14,name:'AllKaBar', description:'myanmarxxn',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/yFYd4rgz/photo-2025-09-17-18-24-51.jpg',downloadUrl:'https://www.mediafire.com/file/wa3j36uolt9r8wx/AllKaBar.apk/file'},
        ...
        {id:37,name:'AllVideoDownloader',description:'Downloader',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/C5HfBgMq/photo-2025-09-18-15-12-48.jpg',downloadUrl:'https://www.mediafire.com/file/ebteevjdthbzzsj/All_Video_Downloader_v1.7.2_Modded_by_%2540Getmodpcs.apk/file'},
        ...
        {id:40,name:'TurboVPN Premium',description:'freePremium',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/ycfbQwfn/photo-2025-09-18-15-12-39.jpg',downloadUrl:'https://www.mediafire.com/file/gtltcs1mzki5c91/Turbo_VPN_Premium_v4.3.1.8_Modded_by_%2540Getmodpcs.apk/file'},
        ...
        {id:42,name:'Ai Chat Assistant',description:'modversion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/hFvZrwB2/photo-2025-09-18-15-12-17.jpg',downloadUrl:'https://www.mediafire.com/file/51vqzemcoexyl6y/Chat_Smith_Premium_v8.251105.8_Modded_by_%2540Getmodpcs.apk/file'},
        ...
        {id:46,name:'Telegram Premium',description:'FreeVersion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/fd0r9r0j/photo-2025-09-19-01-11-43.jpg',downloadUrl:'https://www.mediafire.com/file/7ipy7brs863eywr/Telegram_Premium_v12.2.0_Modded_by_%2540Getmodpcs.apk/file'},
        ...
        {id:48,name:'AutoClicker',description:'FreeVersion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/vCxVzcqL/photo-2025-09-19-01-12-01.jpg',downloadUrl:'https://www.mediafire.com/file/nru2908tnni49s9/Auto_Clicker_Pro_v2.6.0_Modded_by_%2540Getmodpcs.apk/file'},
        {id:49,name:'Chatgpt Premium',description:'FreeVersion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/Sw6ctmTM/download.png',downloadUrl:'https://www.mediafire.com/file/uuzy14nlgqnc4pf/Ai-Chatbot-v5.2.0.2-MOD-OTR-%2528Getmodsapk.com%2529.apk/file'},
        {id:50,name:'TeraBox Cloud Storage',description:'FreeVersion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/mrNs6MTk/photo-2025-09-19-01-42-56.jpg',downloadUrl:'https://files.modyolo.com/Terabox/TeraBox_%20v4.5.3%20_MOD.apk'},
        ...
        {id:52,name:'Tennis Clash v6.18.2 MOD APK',description:'game',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/media/2025/5/tennis-clash-mod-apk-1-1.webp',downloadUrl:'https://getmodsapk.com/dl-track/tennis-clash-3d-modded-apk/209666'},
        {id:53,name:'Cat Runner',description:'Unlimited Money/Gems',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/Cat-Runner-MOD-APK%20(2)1.webp',downloadUrl:'https://getmodsapk.com/dl-track/cat-runner-mod-apk/212522'},
        {id:54,name:'Hot Slide',description:'Unlimited Money/Unlocked',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/media/2025/9/hot-slide-mod-apk.webp',downloadUrl:'https://getmodsapk.com/dl-track/hot-slide-mod-apk/210984'},
        {id:55,name:'CarX Highway Racing',description:'Unlimited Money/VIP Unlocked',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/CarX%20Highway%20Racing%20MOD%20APK%20(1)0.webp',downloadUrl:'https://getmodsapk.com/dl-track/carx-highway-racing-apk-mod/211881'},
        {id:56,name:'Invasion: Aerial Warfare',description:'Unlimited Money/Energy',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/Invasion%20Modern%20Empire%20MOD%20APK4.webp',downloadUrl:'https://getmodsapk.com/dl-track/invasion-modern-empire-mod-apk/210877'},
        {id:57,name:'Tacticool',description:'Mod Menu/Unlimited Money',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://getmodsapk.com/storage/Tacticool%20MOD%20APK%20(1)3.webp',downloadUrl:'https://getmodsapk.com/dl-track/tacticool-mod-apk/210869'},
    ];
