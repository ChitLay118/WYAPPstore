document.addEventListener('DOMContentLoaded', () => {
    ...
    const dummyApps = [
        ...
        {id:34,name:'CapCut pro',category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/bM2hk21J/CFGW9pccdthic-Kai-M5-Tbh5.png',downloadUrl:'https://www.mediafire.com/file/b6gz0wb4lhn2q6o/CapCut_Pro_v15.7.0_%2540Getmodpcs%2528WYappstore%2529.apk/file'},
        ...
        {id:63,name:'Amazon Prime Video',category:'Entertainment',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2021/09/amazon-prime-video-150x150.jpg',downloadUrl:'https://files.modyolo.com/Amazon%20Prime%20Video/Amazon_Prime_Video_%20v3.0.424.547%20_MOD.apk'},
        ...
        {id:72,name:'WY MovieBox',category:'Entertainment',isFeatured:false,iconUrl:'https://i.ibb.co/3mm1SwVj/photo-2025-09-26-02-06-35.jpg',downloadUrl:'https://www.mediafire.com/file/lh7ke9wkc4hzhhy/WY_MovieBox.apk/file'},
        {id:72,name:'စွယ်စုံ',category:'Entertainment',isFeatured:false,iconUrl:'https://i.ibb.co/B1Z55vc/download.jpg',downloadUrl:'https://www.mediafire.com/file/420e47wxrr1h5gf/%25E1%2580%2585%25E1%2580%25BD%25E1%2580%259A%25E1%2580%25BA%25E1%2580%2585%25E1%2580%25AF%25E1%2580%25B6.apk/file'},
        {id:72,name:'WiFi Analyzer Premium',category:'Modified Apps',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2021/09/wifi-analyzer-premium-150x150.jpg',downloadUrl:'https://files.modyolo.com/WiFi%20Analyzer%20Premium/WiFi_Analyzer_%20v6.7%20_MOD.apk'},
        {id:72,name:'VK',category:'Modified Apps',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2022/03/vk-music-video-messenger-150x150.jpg',downloadUrl:'https://files.modyolo.com/VK/VK_%20v8.151%20x.xapk'},
        {id:72,name:'Logo Maker & Designer',category:'Modified Apps',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2021/12/logo-maker-2021-3d-logo-designer-logo-creator-app-150x150.jpg',downloadUrl:'https://files.modyolo.com/Logo%20Maker/Logo_Maker_%20v1.1.60%20_MOD.apk'},
        {id:72,name:'MX Player Pro',category:'Modified Apps',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2021/09/mx-player-pro-apk-mod-150x150.png',downloadUrl:'https://files.modyolo.com/Mx%20player/MX_Player_%20v2.1.1%20x.apk'},
        {id:72,name:'VidMate',category:'Modified Apps',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2022/11/vidmate-150x150.png',downloadUrl:'https://files.modyolo.com/VidMate/VidMate_%20v5.3431%20x.apk'},
        {id:72,name:'Acode',category:'Development',isFeatured:false,iconUrl:'https://modyolo.com/wp-content/uploads/2022/02/acode-powerful-code-editor-150x150.jpg',downloadUrl:'https://files.modyolo.com/Acode/Acode%20v1.11.4.apk'},
    ];
    ...
    searchInput.addEventListener('input', e => {
        ...
        // Add active class to "All Apps" button
        document.querySelector('.bottom-nav-item[data-category="All Apps"]').classList.add('active');
        updateUI();
    });
